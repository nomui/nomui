 ...
 */ (function (global, factory) {
  ...
  */ Date.$VERSION = 1.02; // Utility function to append a 0 to single-digit numbers
        ...
        children: [
          {
            ...
            type: "image-pending",
            attrs: { style: { width, height, "font-size": `${size}rem` } },
          },
          {
            tag: "img",
            ref: (c) => {
  ...
  Image.defaults = { src: null, width: null, height: null };
