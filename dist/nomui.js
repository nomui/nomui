(function (global, factory) {
  ...
  class Component {
    ...
    create() {
      ...
      isFunction$1(this._create) && this._create();
    ...
    render() {
      ...
      isFunction$1(this._render) && this._render();
      this._callMixin('_render');
      isFunction$1(this.props._render) && this.props._render.call(this);
    ...
    _renderChildren() {
      ...
      } else if (isPlainObject(children) || isFunction$1(children)) {
  ...
  class Control extends Component {
    ...
    getValue() {
      const value = isFunction$1(this._getValue) ? this._getValue() : null;
      return value
    }
  ...
  */
  ...
  class MenuItemWrapper extends Component {
    ...
    _config() {
      ...
      const menuProps = menu.props;
      const expanded =
        menuProps.type === 'horizontal' || menuProps.itemExpandable.initExpandLevel >= this.level;
