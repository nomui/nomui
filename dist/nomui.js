(function (global, factory) {
      ...
      if ((options = arguments[i]) != null) {
        ...
        for (name in options) {
          ...
          if (deep && copy && isPlainObject(copy)) {
            ...
            target[name] = extend$1(deep, _clone, copy);
  ...
  function position(elem, options) {
    ...
    const basePosition = extend$1({}, targetOffset)
    ...
    _config() {
      ...
      this.setProps({
        children: [
          ...
          n$1(null, Component.extendProps(control, { classes: { 'nom-control': true } }), null, [
            ControlMixin,
          ]),
          extra && {
            tag: 'div',
  ...
  class AutoCompleteList extends List {
    ...
    _config() {
      ...
      this.setProps({
        items: options || [],
        itemDefaults: n$1(null, optionDefaults, null, [AutoCompleteListItemMixin]),
        itemSelectable: {
          multiple: false,
          byClick: true,
          scrollIntoView: true,
